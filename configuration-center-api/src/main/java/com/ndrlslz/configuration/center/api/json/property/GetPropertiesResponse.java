...
public class GetPropertiesResponse {
    @JsonProperty("data")
    @ApiModelProperty(value = "Properties Information", required = true, position = 1)
    private List<Data<Property>> data;
    ...
    public List<Data<Property>> getData() {
        return data;
    }

    public void setData(List<Data<Property>> data) {
        this.data = data;
    }
